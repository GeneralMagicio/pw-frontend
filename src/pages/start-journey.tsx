...
export default function StartJourney() {
  ...
  return (
    <>
      <div className="relative m-auto mt-32 flex max-w-[1158px] flex-col gap-6 rounded-[20px] bg-white px-20  py-10 font-Inter   text-black">
        <div className="flex flex-col items-center justify-center gap-6">
          <header className="mb-2 flex w-full ">
            <h1 className="font-IBM text-3xl font-bold">
          ...
          <div className="mt-10 flex w-full justify-between">
            <div
              ...
              <button
                className="mt-5 flex h-12 min-w-[120px] items-center self-center rounded-full  bg-black px-8 font-IBM font-bold text-white"
